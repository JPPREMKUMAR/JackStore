...
const Collection = () => {
    ...
    return (
        ...
        <div className=" flex flex-col sm:flex flex-row gap-1 sm:gap-10 pt-10 border-t">

            {/*Filter Options */}
            <div>
                <div className="min-w-60">

                    <p onClick={onToggleFilter} className="my-2 text-xl flex items-center cursor-pointer gap-2">FILTERS
