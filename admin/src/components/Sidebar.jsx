...
const Sidebar = () => {
    ...
    return (
        ...
        <div className='w-[100px] md:w-[300px] min-h-screen border border-gray-300 '>
            <div className='flex flex-col gap-4 px-4 py-2 pt-6 pl-[20%] text-[15px]'>

                <NavLink to='/add' className='flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-lg'>
                    <img
                        src={assets.add_icon} className="w-5 h-5"
                        alt=""
                    />
                ...
                <NavLink to='/list' className='flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-lg'>
                    <img
                        src={assets.order_icon} className="w-5 h-5"
                        alt=""
                    />
